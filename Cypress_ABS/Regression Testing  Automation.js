...
//     cy.get('@firstNameInput').should('be.visible').click().type('Archiel', { delay: 100 });
//     cy.get(':nth-child(2) > :nth-child(2) > .relative > .rounded-lg').should('be.visible').click().type('L.',{delay: 100});
//     cy.get(':nth-child(3) > .relative > .rounded-lg').should('be.visible').click().type('Jay', { delay: 100 });
...
//         .type('ARCHIEL {enter}', { delay: 200 }); // Type the new text with a delay
...
//   //    cy.get('#search-id').click().type('CHARINA {enter}', {delay:200});
...
//   .type('2025-01-07', { delay: 100 }); // Type the date in YYYY-MM-DD format
